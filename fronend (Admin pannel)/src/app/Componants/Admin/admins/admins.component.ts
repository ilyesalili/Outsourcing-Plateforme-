...
export class AdminsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    if ((this.dataSource = new MatTableDataSource(ELEMENT_DATA))) {
  ...
  deleteItem(item: any): void {
    // Afficher une confirmation de suppression et effectuer la suppression de l'élément
  ...
  blockItem(item: any): void {
    // Modifier le statut de blocage de l'élément et enregistrer les modifications
